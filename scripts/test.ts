...
async function main() {
    // yarn run ts-node --files .\scripts\test.ts 0 "0x01592c6e3d8eF0499D9E438Ca4a47e3709208202" "" 1 10
    ...
    let voteTx = await ballotContract.vote(votedProposalIndex, ethers.utils.formatEther(voteAmount));
    await voteTx.wait();
